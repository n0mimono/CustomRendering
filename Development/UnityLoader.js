...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Painter.data';
    var REMOTE_PACKAGE_BASE = 'Painter.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3510091;
      var PACKAGE_UUID = 'f08c884f-7b31-425f-8ec4-71b8a9642896';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 713880, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(713880, 714056, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(714056, 717310, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(717310, 2607494, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2607494, 3482466, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3482466, 3510091, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    Module['addRunDependency']('datafile_Painter.data');
